...
def test(test_x):
    ...
    aug_image = tf.map_fn(lambda img: tf.image.random_brightness(img, 60/255.0), aug_image)
    ...
    with tf.Session() as sess:
        ...
        ckpt = tf.train.get_checkpoint_state('./model/vgg19')
